...
author: "周舒畅"
source_url: https://www.zhihu.com/question/658056360/answer/3529850082
platform: zhihu
collection: "学习收藏"
...
> 作者: 周舒畅 | 来源: https://www.zhihu.com/question/658056360/answer/3529850082
...
已关注
收录于 · 大模型读大模型论文
hzwer 黄哲威 等 1335 人赞同了该回答

我有十计，可打开局面

倒反天罡：用 Diffusion 来做图像理解（Generative Visual Question Answering），又比如利用 cycle consistence loss
缺啥补啥：Diffusion 模型一般空间布局能力弱，张冠李戴严重，可以沿着 LLM-Grounded-Diffusion、RPG、RL-Diffusion 这些个工作的方向前进（详见链接中思考题）。
好风借力：最新一批视频大模型逐渐出来，可以结合它们和 3D 生成，和 3D 重建（Gaussian Splatting），及必经之路：“和 Control-Net 结合”。
尺短寸长：思考 Diffusion 循环和 MaskGIT 的关系，特别考虑到最近的工作：An Image is Worth 32 Tokens for Reconstruction and Generation
亲吻大地：找找还没有被 Diffusion 影响的应用方向
非欧几何：跳出欧几里得平面几何，研究球面上的 Diffusion（用于天气预报），genus非 0 面（咖啡杯）上的 Texture 生成（TexFusion）。
穷根究底：对 cross attention 等部分仔细研究，寻求 mechanistic interpretability
借花献佛：把相关工作如 DiT 用 Mamba / xLSTM 再搞一遍
移花接木：把类似 VAR 的多尺度概念引到 Diffusion 模型
海纳百川：利用类似 Mixture-of-Agents 的搞法，把 Huggingface 能下到的（好）模型炖个仙跳墙。

上面每个方向可能都不是无人区，但是用一些搜索关键字找到最近一两个月或半年的文章时，就能知道前沿在哪里。前沿再前进一步，就是创新，就是“入坑”了。

哦，还有一计：

11. 社会工程：认识一位搞 Diffusion 的博士生

( 声明：以上的意思是希望同学尽快进入绿林大学深造，“在战争中学习战争”，没有投机取巧不良引导)

所属专栏 · 2025-05-20 11:57 更新
大模型读大模型论文
周舒畅
​
新知答主
...
收起​
我是不是不适合从事嵌入式开发啊……?
作为一名曾经的计算机科学与技术专业的学生，我对“在学校里学的都可以，听的时候能听懂，但是自己做的时候手就不会写了”这种感受深有体会。其实原因就是学校都是理论为主，自己动手做的太少了，而这行又太吃...
从前慢
100+热议
更多回答
cameron
...
关于作者
周舒畅
AI 研究员；小鹏、阶跃、旷视、Google
​
中国科学院大学 计算机科学与技术博士
​
减论(Reduct)、hzwer 黄哲威、任路遥也关注了他
回答
122
文章
987
...
![图片](https://pica.zhimg.com/9c114f9e3df8b693fa7cc2e81c1019c2_l.jpg?source=c8b7c179)

![图片](https://pic1.zhimg.com/v2-658b5ea6d9fae53e9f48ab1877bc8ab8_l.jpg?source=fdaf910d)
...
![图片](https://pic1.zhimg.com/v2-037be32fef38b131c434e594286d5ffb_l.jpg?source=1def8aca)
